...
export class Stories implements OnInit, OnDestroy {
  ...
  slides: StorySlide[] = [
    ...
    { texto: '', imagemUrl: 'terno.jpeg' },
    { texto: '', imagemUrl: '13.jpeg' },
    { texto: '', imagemUrl: '21.jpeg' },
    { texto: '', imagemUrl: 'deitados.jpeg' },
    { texto: '', imagemUrl: 'carro.jpeg' },
    { texto: '', imagemUrl: '43.jpeg' },
    { texto: '', imagemUrl: '57.jpeg' },
    { texto: '', imagemUrl: '7.jpeg' },
    { texto: '', imagemUrl: 'abraço.jpeg' },
    { texto: '', imagemUrl: 'carnaval.jpeg' },
    ...
    { texto: '', imagemUrl: 'lago.jpeg' },
    { texto: '', imagemUrl: '23.jpeg' },
    { texto: '', imagemUrl: '50.jpeg' },
    { texto: '', imagemUrl: 'turistando.gif' },
    { texto: '', imagemUrl: '22.jpeg' },
    { texto: '', imagemUrl: '10.jpeg' },
    { texto: '', imagemUrl: '55.jpeg' },
    { texto: '', imagemUrl: '7.gif' },
    { texto: '', imagemUrl: 'festa.jpeg' },
    { texto: '', imagemUrl: 'pixelshow.jpeg' },
    { texto: '', imagemUrl: '5.gif' },
    { texto: '', imagemUrl: '24.jpeg' },
    { texto: '', imagemUrl: 'eu.gif' },
    { texto: '', imagemUrl: 'conic.jpeg' },
    { texto: '', imagemUrl: '1.gif' },
    { texto: '', imagemUrl: 'dormindo.jpeg' },
    { texto: 'Se eu nao desisti daqui, desisto jamais...', imagemUrl: 'discord.jpeg' },
    { texto: 'Duelo de gigantes', imagemUrl: 'mae.gif' },
  ...
  private precarregarImagem(url: string, prioridade = false): void {
    ...
    if ('fetchPriority' in imagem) {
      (imagem as HTMLImageElement & { fetchPriority: string }).fetchPriority = prioridade
        ? 'high'
        : 'low';
    }
